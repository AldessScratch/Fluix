...
function CleanOutput(output) {
	let roundedOutput = parseFloat(output.toFixed(10)); // Adjust the number of decimal places as needed
	let output_string = roundedOutput.toString().replace('.', ','); // Replace periods with commas
